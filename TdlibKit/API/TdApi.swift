...
public final class TdApi {
    ...
    public func getMessageEmbeddingCode(
        ...
        forAlbum: Bool,
        messageId: Int64,
        completion: @escaping (Result<TextWrapper, Swift.Error>) -> Void) throws {
    ...
    public func getChatListsToAddChat(
        chatId: Int64,
        completion: @escaping (Result<ChatLists, Swift.Error>) -> Void) throws {
    ...
    public func getChatFilter(
        chatFilterId: Int,
        completion: @escaping (Result<ChatFilter, Swift.Error>) -> Void) throws {
    ...
    public func createChatFilter(
        filter: ChatFilter,
        completion: @escaping (Result<ChatFilterInfo, Swift.Error>) -> Void) throws {
    ...
    public func getCountryCode(completion: @escaping (Result<TextWrapper, Swift.Error>) -> Void) throws {
    ...
    public func getInviteText(completion: @escaping (Result<TextWrapper, Swift.Error>) -> Void) throws {
